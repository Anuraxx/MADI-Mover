      ...
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo">
           <a href="index.php">
            <div class="logo-text">
              <p class="madi-text">MADI </p><div class="mover-text-container"><p class="text">M<span class="wheel"><img src="assets/images/wheel.png"/></span>VER</p><div class="upper-cover"></div></div>
            </div>
           </a> 
          </div>
        </div>
...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
	  ...
	  <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">admin</a></li>
            <?php } ?>
          </ul>
            </li>
          </ul>
